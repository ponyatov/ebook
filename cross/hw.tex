...
\lstinputlisting[style=mk,title=cpu.sun4i.mk]{cross/cpu.sun4i.mk}
  \item \file{rpi}
  Конфигурация для платы \raspi
\lstinputlisting[style=mk,title=hw.rpi.mk]{cross/hw.rpi.mk}
\lstinputlisting[style=mk,title=cpu.BCM2835.mk]{cross/cpu.BCM2835.mk}
...
\lstinputlisting[style=mk,title=cpu.armSoftFP.mk]{cross/cpu.armSoftFP.mk}
